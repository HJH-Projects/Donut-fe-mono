...
const RecommendBasicLook = ({
  isLoading,
  recommendation,
  tips,
}: RecommendBasicLookProps) => {
  return (
    <>
        ...
        {isLoading ? (
          ...
          <div className="relative w-full h-full overflow-hidden bg-white" style={{ borderRadius: "32px" }}>
            {recommendation.imageUrl ? (
              <img src={recommendation.imageUrl} alt={recommendation.description || '추천 코디'} className="w-full h-full object-contain" />
            ) : (
