...
const faqs: FAQItem[] = [
  {
    ...
    answer: (
      <>
        ...
        입니다. {'"'}오늘 뭐 입지?{'"'}라는 고민을 날씨 데이터를 바탕으로 스마트하게 해결해
        드립니다.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        모든 서비스는 <strong>무료</strong>로 이용 가능합니다. 별도의 결제 없이 날씨별 스타일링 추천
        기능을 자유롭게 활용하실 수 있습니다.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        일반적인 패션 큐레이션과 달리, <strong>실시간 기온, 습도, 강수 여부 등 기상 변수</strong>를
        최우선으로 고려합니다. 외부 활동 시 쾌적함을 유지하면서도 감각적인 룩을 완성할 수 있도록
        돕는 실용적인 가이드라는 점이 가장 큰 특징입니다. 특히 로그인을 통해 본인의 옷을 등록하고
        조합해보는 기능을 제공하여 개인화된 코디 관리가 가능합니다.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        사용자의 편의를 위해 <strong>카카오, 네이버, 애플 등 주요 소셜 계정 연동(SSO)</strong>{' '}
  ...
  },
  {
    ...
    answer: (
      <>
        마이페이지 내 <strong>계정 관리</strong> 메뉴에서 언제든지 탈퇴가 가능합니다. 탈퇴 시 저장된
        옷장 데이터와 제작한 룩은 모두 파기됩니다.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        불편을 드려 죄송합니다. 발생한 오류의 내용이나 화면 캡처를 고객 지원 메일로 보내주시면
        빠르게 확인하여 조치하겠습니다.
        <br />
        <strong>고객 지원 메일</strong>:{' '}
        <a href="mailto:support@doknot.xyz" className="underline" style={{ color: '#2563EB' }}>
          support@doknot.xyz
        </a>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        사용자의 소중한 의견은 서비스 발전에 큰 힘이 됩니다. 제안하고 싶은 기능이나 아이디어가
        있다면 고객 지원 메일을 통해 언제든 자유롭게 남겨주시기 바랍니다.
        <br />
