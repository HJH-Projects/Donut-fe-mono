...
import { LookForm } from "@/app/components/LookForm";
...
export function Looks() {
  ...
  const [closetItems] = useState<LookItem[]>([
    ...
    { id: "c12", name: "샌���", category: "신발", imageUrl: "https://images.unsplash.com/photo-1743591684800-c8cfba557087?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdW1tZXIlMjBzYW5kYWxzfGVufDF8fHx8MTc3MDA1MTcwMXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" },
  ...
  const handleKakaoShare = () => {
    // 임시: ��유 페이지로 이동
    if (selectedLook) {
      navigate(`/share/${selectedLook.id}`);
