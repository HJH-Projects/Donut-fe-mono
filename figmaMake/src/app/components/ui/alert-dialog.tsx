...
function AlertDialog({
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Root>) {
  return <BaseUIAlertDialog.Root data-slot="alert-dialog" {...props} />;
}

function AlertDialogTrigger({
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Trigger>) {
  return (
...
function AlertDialogOverlay({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Backdrop>) {
  return (
    <BaseUIAlertDialog.Backdrop
...
function AlertDialogContent({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Popup>) {
  return (
...
function AlertDialogTitle({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Title>) {
  return (
...
function AlertDialogDescription({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Description>) {
  return (
...
function AlertDialogAction({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAlertDialog.Close>) {
  return (
